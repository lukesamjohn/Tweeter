...
//    private static final String LOG_TAG = "RegisterFragment";
    ...
    // fields the user can interact with
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageUploaderButton.setOnClickListener(view1 -> {
            Intent gallery = new Intent(Intent.ACTION_PICK, MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
            startActivityForResult(gallery, RESULT_IMAGE);
        });

        registerButton.setOnClickListener(view12 -> presenter.register(firstName.getText().toString(), lastName.getText().toString(), alias.getText().toString(),
